...
from src.tacoxDNA.src.libs.readers import LorenzoReader
...
def convert_cndo_to_oxdna_in_python(cndo_filepath, box_size: 150.):
    opts = {
        "box": box_size,
        "print_force_file": True,
        'cando_file': cndo_filepath
    }
